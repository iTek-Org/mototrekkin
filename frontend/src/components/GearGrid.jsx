...
import bikhire from "../assets/bikehire.webp"

const GearGrid = () => {
  const gearItems = [
    { label: 'RIDER JACKETS', image: riderJackets },
    { label: 'RIDER GLOVES', image: riderGloves },
    { label: 'RIDER BOOTS', image: riderBoots },
    { label: 'TECH-AIR® 5', image: techAir5 },
    { label: 'EAR MOULD', image: earMould },
    { label: 'BAGS', image: bags },
    { label: 'WOMEN’S APPAREL', image: womensApparel },
    { label: 'TOURING', image: touring },
    { label: 'RIM REPAIR', image: rimRepair },
    { label: 'OFF ROAD TYRES', image: offRoadTyres },
    { label: 'ROAD TYRES', image: roadTyres },
    { label: 'BIKE HIRE', image: bikeHire },
  ];
