...
const AdminOrders = () => {
  ...
  return (
    <div className="p-4 w-full h-full text-black">
      ...
      <div className="w-full overflow-auto border border-gray-300 rounded-lg shadow-lg max-h-[80vh]">
        <table className="w-max min-w-full table-auto text-sm text-left border-collapse">
          <thead className="bg-gray-200 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-4 py-2 border-b">Tyres</th>
              <th className="px-4 py-2 border-b">Tyre Details</th>
          ...
          <tbody>
            {bookings.map((b) => (
              <tr key={b._id} className="hover:bg-gray-100">
                ...
                <td className="px-4 py-2 border-b">{b.tyres}</td>
                <td className="px-4 py-2 border-b">{b.tyreDetails}</td>
                ...
                <td className="px-4 py-2 border-b">
                  {b.preferredDateTime
                    ? new Date(b.preferredDateTime).toLocaleString()
                    : "N/A"}
                </td>
                <td className="px-4 py-2 border-b">
                  <button
